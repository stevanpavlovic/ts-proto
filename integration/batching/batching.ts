...
export interface EntityServiceController {
  ...
  batchQuery(request: BatchQueryRequest): Observable<BatchQueryResponse>;

  batchMapQuery(request: BatchMapQueryRequest): Observable<BatchMapQueryResponse>;

  /**
   *  Add a method that is not batchable to show it's still cached
   */
  getOnlyMethod(request: GetOnlyMethodRequest): Observable<GetOnlyMethodResponse>;

  /**
   *  Add a method that won't get cached
   */
  writeMethod(request: WriteMethodRequest): Observable<WriteMethodResponse>;
